export default function Hero() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-6 text-center text-white">
        ...
        <div className="mt-6 flex items-center gap-4">
          <a
            href="/resume.pdf"
            download
            className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-8 py-3 text-sm font-semibold tracking-wide text-white shadow-[0_12px_25px_rgba(37,99,235,0.35)] transition-transform duration-200 hover:-translate-y-0.5 hover:bg-blue-500 hover:shadow-[0_18px_35px_rgba(59,130,246,0.45)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400 active:translate-y-0"
          >
            Download Resume
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none">
              <path
                d="M12 3v12m0 0l4-4m-4 4l-4-4M5 18h14"
                stroke="currentColor"
                strokeWidth="1.8"
                strokeLinecap="round"
          ...
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-900/80 text-white shadow-[0_8px_18px_rgba(17,24,39,0.35)] transition-transform duration-200 hover:-translate-y-0.5 hover:bg-gray-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900 active:translate-y-0"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-700/80 text-white shadow-[0_8px_18px_rgba(37,99,235,0.4)] transition-transform duration-200 hover:-translate-y-0.5 hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700 active:translate-y-0"
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex h-10 w-10 items-center justify-center rounded-full bg-green-600/85 text-white shadow-[0_8px_18px_rgba(22,163,74,0.35)] transition-transform duration-200 hover:-translate-y-0.5 hover:bg-green-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 active:translate-y-0"
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
